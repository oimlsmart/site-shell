...
import { HOST_REGISTRY } from '../src/data/host-registry.mjs'
...
for (const host of HOST_REGISTRY) {
  check(indexHtml.includes(`href="${host.url}"`), `the footer carries the registry link for ${host.key} (host-registry.mjs)`)
}
